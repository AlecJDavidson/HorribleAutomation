...
def read_watch_list(): ### Watch List ###
	watchlist = open(root+'watchlist.txt','r')
	watchlistList = []
	for watchlistEntry in watchlist:
		watchlistList.append(watchlistEntry.strip())
		watchlistList = list(dict.fromkeys(watchlistList))
