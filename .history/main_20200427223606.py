...
rssEntryList = [] # Creates a list of entries
i = 0
while i < len(feed.entries):
    entry = feed.entries[i]
    rssEntryList.append(entry.title)
...
for i in watchlistList: # Iterates over watch list to add new entries
    print(watchlistEntry)
    for watchlistEntry in rssEntryList:
        print('match')
