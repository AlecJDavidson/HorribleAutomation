...
downDir = os.listdir('/home/qbittorrent-nox/Downloads') # Where the torrents are downloaded.
animeDir = ('/home/plex/plex-media/anime/') # Path to anime folder
...
def move_files(): # Moves the files one by one to the directories with matching names.
	i = 0
	while i < len(parse_files()[1]):
		src = '/home/qbittorrent-nox/Downloads/'+parse_files()[0][i]
		dst = animeDir+parse_files()[1][i]
		shutil.move(src,dst)
		i += 1
move_files()